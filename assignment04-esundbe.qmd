...
df_feature = df_eda.dropna(subset=[
  "SALARY","MIN_YEARS_EXPERIENCE","MIN_EDULEVELS_NAME","EMPLOYMENT_TYPE_NAME","REMOTE_TYPE_NAME","IS_INTERNSHIP","COMPANY_IS_STAFFING", "DURATION"
])

categorical_cols = ["MIN_EDULEVELS_NAME", "EMPLOYMENT_TYPE_NAME", "REMOTE_TYPE_NAME"]
